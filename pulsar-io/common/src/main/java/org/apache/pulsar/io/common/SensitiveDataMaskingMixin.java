...
/**
 * Jackson mixin interface for implementing sensitive data masking in serialization output.
 * Used with Jackson's addMixIn method to apply to config classes without modifying them.
 */
